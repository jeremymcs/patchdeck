...
export const issueSchema = z.object({
  ...
  createdAt: z.string(),
  updatedAt: z.string(),
  lastSyncAttemptedAt: z.string().nullable().optional(),
  lastSyncSucceededAt: z.string().nullable().optional(),
  ...
  externalWorkPrNumber: z.number().nullable().optional(),
  externalWorkPrUrl: z.string().nullable().optional(),
  externalWorkPrRepo: z.string().nullable().optional(),
