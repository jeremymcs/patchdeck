...
patchdeck includes a built-in PR question-answering system that lets you interrogate your pull requests using natural language.
...
patchdeck queues the question as a durable background job and asks the configured local agent to answer from the PR context currently stored in the app.

## How to Use

1. Open a PR in the patchdeck dashboard.
