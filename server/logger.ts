...
function resolveLogFilePath(): string | null {
  if (process.env.PATCHDECK_NO_LOG_FILE === "1" || process.env.OH_MY_PR_NO_LOG_FILE === "1") return null;
  const override = process.env.PATCHDECK_LOG_FILE ?? process.env.OH_MY_PR_LOG_FILE;
