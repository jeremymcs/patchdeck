...
const GITHUB_RELEASES_URL = "https://github.com/jeremymcs/patchdeck/releases";
const GITHUB_LATEST_RELEASE_API_URL = "https://api.github.com/repos/jeremymcs/patchdeck/releases/latest";
  ...
  try {
    const response = await fetchImpl(GITHUB_LATEST_RELEASE_API_URL, {
      headers: {
        ...
        "user-agent": `patchdeck/${trimmedCurrentVersion}`,
      },
    });
