...
const REPO_URL = "https://github.com/jeremymcs/patchdeck";
const COMMUNITY_URL = "https://github.com/jeremymcs/patchdeck/discussions";
const CHANGELOG_URL = "https://github.com/jeremymcs/patchdeck/releases";
const ISSUES_URL = "https://github.com/jeremymcs/patchdeck/issues";
const API_REFERENCE_URL = "https://github.com/jeremymcs/patchdeck/blob/main/LOCAL_API.md";
const CONTRIBUTING_URL = "https://github.com/jeremymcs/patchdeck/blob/main/CONTRIBUTING.md";
const AGENT_CONFIG_URL = "https://github.com/jeremymcs/patchdeck/blob/main/AGENTS.md";
...
const DOC_DEFINITIONS: DocDefinition[] = [
  {
    ...
    icon: "quickstart",
    fallbackDescription: "Install patchdeck, connect a repository, and let the agents handle your first PR in minutes.",
  },
  {
    slug: "configuration",
    section: "Getting Started",
  ...
  },
  {
    ...
    icon: "package",
    fallbackDescription: "How patchdeck dispatches Claude Code and OpenAI Codex agents in isolated worktrees.",
  },
  {
    slug: "pr-questions",
    section: "Core Concepts",
...
const WORKFLOW_STEPS = [
  {
    ...
    description: "Add any GitHub repository. patchdeck polls for open PRs and new review activity.",
  },
  {
    number: "2.",
    title: "Sync Reviews",
...
function renderLandingPage(context: RenderContext, docs: DocMeta[]): string {
  ...
  <h1 class="mb-5 text-4xl font-bold tracking-normal text-white sm:text-5xl">patchdeck</h1>
  <p class="mb-8 max-w-3xl text-lg leading-relaxed text-gray-400">
    patchdeck watches your GitHub repositories, triages review feedback, and dispatches local AI agents to fix code so you can focus on building instead of babysitting pull requests.
  </p>
...
<section class="mb-8">
  ...
  <div class="border-t border-dark-700">
    ...
    <a class="group flex items-start justify-between gap-6 border-b border-dark-700 py-4 transition-colors hover:border-brand-500/60 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-400" href="${API_REFERENCE_URL}" target="_blank" rel="noreferrer">
      <span class="min-w-0">
        ...
        <span class="mt-1 block text-sm leading-relaxed text-gray-400">Full REST API documentation for programmatic control of patchdeck.</span>
      </span>
  ...
  return renderShell(
    context,
    "patchdeck Documentation",
    "patchdeck documentation for the autonomous PR babysitter that watches repositories, triages review feedback, and dispatches local AI agents to fix code.",
    "intro",
    bodyContent,
    docs,
    {
...
<article class="doc-prose">
  ...
  return renderShell(
    context,
    `${doc.title} | patchdeck Docs`,
    `${doc.title} - patchdeck documentation`,
    doc.slug,
    bodyContent,
    docs,
    bottomNav,
